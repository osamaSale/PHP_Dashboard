        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class='form-group'>
                    <input type='text' name='name' id='id' required class='form-control'>
                </div>
                <div class='form-group'>
                    <label>Name</label>
                ...
                <div class='form-group'>
                    <label>Email</label>
                    <input type='text' name='email' id='email1' required class='form-control'>
                </div>
                <div class='form-group'>
                ...
                <div class='form-group'>
                    ...
                    <select class='form-control' name='authorization' id='authorization1'>
                        <option selected>Open this select menu</option>
                        <option value="user">User</option>
                        <option value="admin">Admin</option>
                    </select>
                </div>
                <input type='submit' value='Submit' class='btn btn-success' id="editUser">
            </div>
        </div>
    </div>
</div>